...
def gen_train_test_datasets():
    input_img_path = "../../DATA/train/images"
    gt_img_path = "../../DATA/train/annotations"
    gt_save_path= "./datasets"
    ...
    train_inputs, val_inputs, train_gts, val_gts = \
        train_test_split(input_imgs, gt_jsons, test_size=0.1, random_state=321)
